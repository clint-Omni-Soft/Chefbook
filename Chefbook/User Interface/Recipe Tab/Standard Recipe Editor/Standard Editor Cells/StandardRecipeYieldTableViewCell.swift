//
//  StandardRecipeYieldTableViewCell.swift
//  Chefbook
//
...
class StandardRecipeYieldTableViewCell: UITableViewCell {
    ...
    weak var delegate : StandardRecipeYieldTableViewCellDelegate!
    ...
    func initializeWith( quantity : Int,
                         weight   : Int,
                         delegate : StandardRecipeYieldTableViewCellDelegate ) {
//        logTrace()
...
//        logTrace()
        ...
        if !inEditMode {
            ...
            delegate.standardRecipeYieldTableViewCell( standardRecipeYieldTableViewCell : self,
